        ...
        <section className="landing">
            <div className="container">
                <h1 className="landing__title">
                    ...
                    <Typewriter onInit={typewriter => {
                        typewriter.typeString('ما به هر قیمتی دوره آموزشی تولید نمی کنیم !')
                            ...
                            .pauseFor(2000)
                            .deleteAll()
                            .typeString('کد استور - آموزش و پیشرفت')
                            .start()
                            .pauseFor(1500)
                    }}
                        options={{
                ...
                <h2 className="landing__subtitle">
                    با آکادمی کدلرن , برنامه نویسی رو با خیال راحت یاد بگیر و پیشرفت کن.
                </h2>
                ...
                <div className="landing-status">
                    <div className="landing-status__item">
                        ...
                        <LandingCounter count={150} />
                        <span className="landing-status__text">
                            کاربر توی کدلرن ثبت نام کردن
                        </span>
                    </div>
